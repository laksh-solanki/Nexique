          ...
          >
            ...
            <div class="rounded-sm bg-primary p-7 text-primary-foreground">
              ...
              <p class="font-display text-2xl italic leading-snug">
                "Some moments are too precious to forget. Some feelings are too deep to speak. Hold
                them close, forever."
              </p>
            ...
            <div class="rounded-sm bg-primary p-7 text-primary-foreground">
              ...
              <p class="font-display text-2xl italic leading-snug">
                "Every moment deserves to be remembered. Every emotion deserves to be expressed.
